        ...
        <div className="mt-28 mx-20">
            ...
            </div>
            {
                ...
                <div>
                    ...
                    <div className="bg-[#212121] fixed top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] z-20 rounded-md shadow-lg shadow-indigo-500/10">
                        <div className="relative flex flex-col justify-center items-center w-[300px] h-[200px] rounded-md">
                            ...
                            <div className="flex gap-4 bg-transparent">
                                <button onClick={()=>setType("MERN")} className={`${type==="MERN" ? "bg-indigo-500/50" : ""} hover:bg-indigo-500/50 text-indigo-200 px-2 py-1 rounded-md`}>MERN</button>
                                <button onClick={()=>setType("Java")} className={` ${type==="Java" ? "bg-indigo-500/50" : ""} hover:bg-indigo-500/50 text-indigo-200 px-2 py-1 rounded-md`}>Java</button>
                                <button onClick={()=>setType("DSA")} className={` ${type==="DSA" ? "bg-indigo-500/50" : ""} hover:bg-indigo-500/50 text-indigo-200 px-2 py-1 rounded-md`}>DSA</button>
                            </div>
